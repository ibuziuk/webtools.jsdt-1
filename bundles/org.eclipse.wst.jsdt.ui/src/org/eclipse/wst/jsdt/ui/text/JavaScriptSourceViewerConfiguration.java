...
import org.eclipse.wst.jsdt.internal.ui.text.javascript.ContentAssistProcessor;
import org.eclipse.wst.jsdt.internal.ui.text.javascript.JavaAutoIndentStrategy;
...
import org.eclipse.wst.jsdt.internal.ui.text.javascript.JavaDoubleClickSelector;
import org.eclipse.wst.jsdt.internal.ui.text.javascript.JavaFormattingStrategy;
import org.eclipse.wst.jsdt.internal.ui.text.javascript.JavaStringAutoIndentStrategy;
import org.eclipse.wst.jsdt.internal.ui.text.javascript.JavaStringDoubleClickSelector;
import org.eclipse.wst.jsdt.internal.ui.text.javascript.JavadocDoubleClickStrategy;
import org.eclipse.wst.jsdt.internal.ui.text.javascript.SmartSemicolonAutoEditStrategy;
...
public class JavaScriptSourceViewerConfiguration extends TextSourceViewerConfiguration {
	 ...
	 * {@link JavaScriptSourceViewerConfiguration#handlePropertyChangeEvent(PropertyChangeEvent)}
	 ...
	 *
	 */
	public JavaScriptSourceViewerConfiguration(final IColorManager colorManager, final IPreferenceStore preferenceStore, final ITextEditor editor, final String partitioning) {
	 ...
	 *
	 * @param javaTextTools
	 *            the JavaScript text tools
	 * @return the combined read-only preference store
	 *
	 */
	private static final IPreferenceStore createPreferenceStore(final JavaScriptTextTools javaTextTools) {
	...
	/*
	 * @see org.eclipse.jface.text.source.SourceViewerConfiguration#
	 * getAutoEditStrategies(org.eclipse.jface.text.source.ISourceViewer,
	 * java.lang.String)
	 */
	@Override
	...
	/*
	 * @see SourceViewerConfiguration#getDefaultPrefixes(ISourceViewer,
	 * String)
	 *
	 */
	@Override
	...
	/*
	 * @see SourceViewerConfiguration#getOverviewRulerAnnotationHover(
	 * ISourceViewer)
	 *
	 */
	@Override
	...
	/*
	 * @see SourceViewerConfiguration#getConfiguredTextHoverStateMasks(
	 * ISourceViewer, String)
	 *
	 */
	@Override
	...
	private IInformationControlCreator getHierarchyPresenterControlCreator(final ISourceViewer sourceViewer) {
		return new IInformationControlCreator() {
			public IInformationControl createInformationControl(final Shell parent) {
				int shellStyle = SWT.RESIZE;
				int treeStyle = SWT.V_SCROLL | SWT.H_SCROLL;
	 ...
	 *            used to compute the JavaScript element
	 ...
	 * @see JavaScriptSourceViewerConfiguration#JavaSourceViewerConfiguration(IColorManager,
	...
	/*
	 * @see org.eclipse.jface.text.source.SourceViewerConfiguration#
	 * getHyperlinkDetectorTargets(org.eclipse.jface.text.source.
	 * ISourceViewer)
	 *
	 */
	@Override
